...
const Two = () => {
  return (
    <div className='bg-[#dfb645] w-full h-full rounded-md flex flex-col justify-center relative'>
      <p className='leading-none text-xl px-3 text-black font-medium'>Write your content using AI.</p>
      <div className='p-2'>
        <div className='bg-white p-2 rounded-lg'>
          ...
          <div className='flex justify-between p-1'>
            ...
            <div className='bg-[#ddc071] px-3 py-1 rounded-sm'>
              <p className='text-black text-xs'>Sure! Here are 5 steps to learn any new skill faster...</p>
            </div>
          </div>
        </div>
      </div>
      <div className='bg-[#dfb645] inline-flex items-center justify-center w-fit h-fit rounded-full border-5 absolute right-1 top-35'>
